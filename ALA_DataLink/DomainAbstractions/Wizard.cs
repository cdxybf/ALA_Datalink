...
namespace DomainAbstractions
{
    ...
    // The Back key, which only appears if it is connected somewhere, hides and deactivates the wizard.It typically connects to the left input of a previous wizard (which causes it to redisplay as it is usually active but hidden).
