...
namespace DomainAbstractions
{
    ...
    // Height, Title and show the maximum, minimum, close or not by sending parameters in constructor. It has two inputs:
    // 1. The IEvent for close the window(if it's active) or open the window(if it's not active);
    ...
    public class PopupWindow : IEvent, IDataFlow<bool>
    {
        ...
        void IEvent.Execute() => ShowWindow(!window.IsActive);
